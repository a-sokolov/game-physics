...
Здесь `./assets/enemies` лежат тайлы и JSON'ы описания анимации:
- attack - атака
- idle - ожидание
- move - движение
...
### Tiled Map Editor
Немного, как организовано хранение уровня и все его свойства.
Оказалось, что все параметры уровня:
- карта уровня
...
удобно хранить в `tmx` формате, с дальнейшей выгрузкой в JSON формат.
